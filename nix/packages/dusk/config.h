...
static int vertpad                       = 0;   /* vertical (outer) padding of bar */
static int sidepad                       = 0;   /* horizontal (outer) padding of bar */
...
//	|SwallowFloating // keep floating applications from swallowing Kitty, matching the former DWM configuration
...
static int flexwintitle_masterweight     = 1;  // give each visible tiled window an equal share of the title area
static int flexwintitle_stackweight      = 1;  // give each visible tiled window an equal share of the title area
...
static const char *fonts[]               = { "JetBrainsMonoNL NFP:size=13:style=Bold", "Font Awesome 6 Free Solid:size=13" };
static       char dmenufont[60]          = "JetBrainsMonoNL NFP:size=20:style=Bold";

static char dmenunormfgcolor[] = "#ebdbb2";
static char dmenunormbgcolor[] = "#282828";
static char dmenuselfgcolor[] = "#fbf1c7";
static char dmenuselbgcolor[] = "#e78a3e";
static char dmenubordercolor[] = "#3c3836";
...
static char *colors[SchemeLast][4] = {
	...
	[SchemeTitleNorm]    = { "#ebdbb2", "#282828", "#3c3836" },
	[SchemeTitleSel]     = { "#fbf1c7", "#e78a3e", "#e78a3e" },
	[SchemeScratchNorm]  = { "#ebdbb2", "#282828", "#3c3836" },
	[SchemeScratchSel]   = { "#fbf1c7", "#e78a3e", "#e78a3e" },
	[SchemeHidNorm]      = { "#e78a3e", "#282828", "#e78a3e" },
	[SchemeHidSel]       = { "#fbf1c7", "#e78a3e", "#e78a3e" },
	[SchemeUrg]          = { "#fbf1c7", "#e78a3e", "#e78a3e" },
	[SchemeMarked]       = { "#fbf1c7", "#e78a3e", "#e78a3e" },
	[SchemeWsNorm]       = { "#ebdbb2", "#282828", "#3c3836" },
	[SchemeWsVisible]    = { "#ebdbb2", "#282828", "#3c3836" },
	[SchemeWsSel]        = { "#fbf1c7", "#e78a3e", "#e78a3e" },
	[SchemeWsOcc]        = { "#ebdbb2", "#282828", "#3c3836" },
};
...
static Rule clientrules[] = {
	...
	{ .class = "Gimp", .flags = Floating },
	{ .class = "Firefox", .workspace = "9" },
	{ .class = "kitty", .flags = Terminal }, // Kitty is eligible to be swallowed by child applications
	{ .class = "st-256color", .flags = Terminal },
...
static BarDef bars[] = {
	...
	{  0,      0,   0,    "0%    100%   100% -1h ", "Primary bottom" },
};
 ...
 */
/* Keep the bar's original module arrangement, but suppress all powerline
 * separators (including the forward-slash triangles between status blocks). */
#define PWRL 0
...
static int enablegaps  = 0;    /* whether gaps are enabled by default or not */
...
static const char *termcmd[]  = { NULL, "/bin/sh", "-c", "exec \"$TERMINAL\"", NULL };
...
static const char *flameshot[] = { NULL, "flameshot", "gui", NULL };
static const char *statusclickcmd[] = { "~/bin/statusbar/statusclick.sh", NULL };

static Key keys[] = {
	/* type       modifier                      key              function                argument */
	{ KeyPress,   MODKEY,                       XK_space,        spawn,                  {.v = dmenucmd } }, // spawn dmenu for launching other programs
	...
	{ KeyPress,   MODKEY,                       XK_s,            showhideclient,         {0} }, // hide or show the selected client
	{ KeyPress,   MODKEY,                       XK_q,            killclient,             {0} }, // close the currently focused window
	{ KeyPress,   MODKEY|Shift,                 XK_c,            restart,                {0} }, // restart dusk
	{ KeyPress,   MODKEY|Shift,                 XK_e,            quit,                   {0} }, // exit dusk
	...
	{ KeyPress,   MODKEY,                       XK_m,            setlayout,              {.i = 1} }, // monocle layout
	...
	{ KeyPress,   MODKEY,                       XK_t,            setlayout,              {.i = 0} }, // tile layout
	{ KeyPress,   MODKEY,                       XK_f,            setlayout,              {.i = 2} }, // floating layout

	{ KeyPress,   MODKEY|Ctrl,                  XK_g,            floatpos,               {.v = "50% 50% 80% 80%" } }, // center client and take up 80% of the screen
	{ KeyPress,   MODKEY|Shift,                 XK_space,        togglefloating,         {0} }, // toggles floating for the currently focused client
	...
	{ KeyPress,   0,                            XF86XK_AudioMute,           spawn, SHCMD("pactl set-sink-mute @DEFAULT_SINK@ toggle; pkill -RTMIN+1 dwmblocks") },
	{ KeyPress,   0,                            XF86XK_AudioLowerVolume,    spawn, SHCMD("pactl set-sink-volume @DEFAULT_SINK@ -3%; pkill -RTMIN+1 dwmblocks") },
	{ KeyPress,   0,                            XF86XK_AudioRaiseVolume,    spawn, SHCMD("pactl set-sink-volume @DEFAULT_SINK@ +3%; pkill -RTMIN+1 dwmblocks") },
	{ KeyPress,   0,                            XF86XK_MonBrightnessUp,     spawn, SHCMD("brightnessctl set +5%; pkill -RTMIN+2 dwmblocks") },
	{ KeyPress,   0,                            XF86XK_MonBrightnessDown,   spawn, SHCMD("brightnessctl set 5%-; pkill -RTMIN+2 dwmblocks") },
	{ KeyPress,   0,                            XK_Print,                    spawn, {.v = flameshot } },
